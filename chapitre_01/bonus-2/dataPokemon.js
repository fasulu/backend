// Details of pokemon API stored in pokemons variable
...
function getNamePokemon(id) {
  ...
  for (i = 0; i < pokemons.length; i++) {
    ...
    // console.log(pokemons[i].url.substring(34).replace("/", ""));
    
    if(currentId === id) {

      console.log(`the name is ${pokemons[i].name}`);
...
// console.log(getNamePokemon("150"));
